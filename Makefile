...
CPPFLAGS            += -I$(PUREGEV_ROOT)/include -I/usr/local/include/opencv4 -I.  
...
LDFLAGS      += -pthread -Wl,-rpath=$(PUREGEV_ROOT)/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_video -lopencv_objdetect 
CUDAFLAGS    += -lpthread -lcudart -lcublas -lopencv_cudafeatures2d
...
# Configure Genicam
GEN_LIB_PATH = $(PUREGEV_ROOT)/lib/genicam/bin/Linux64_ARM
...
$(EXEC): $(OBJS)
	$(NVCC) $(OBJS) -o $@ $(CUDAFLAGS) $(LIBDIRS) $(INCDIRS) $(LDFLAGS) 
